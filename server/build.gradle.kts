...
application {
    // Specify the main class for the server application
    mainClass.set("eu.torvian.mcp.helloworld.server.HelloWorldServerKt")
}

tasks.jar {
    archiveFileName.set("mcp-hello-world-server.jar")
    manifest {
        attributes["Main-Class"] = "eu.torvian.mcp.helloworld.server.HelloWorldServerKt"
    }
